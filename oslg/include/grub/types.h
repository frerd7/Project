...
/* Define burg env */
#define BURG_VAR_UNUSED __attribute__((unused))

#define BURG_VAR_ALIG_P __attribute__ ((packed)) 
#define BURG_VAR_ALIG_8 __attribute__ ((aligned(8))) 
#define BURG_VAR_ALIG_4 __attribute__ ((aligned(4)))
